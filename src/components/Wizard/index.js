...
export default() => {
	...
	const switchToFull = uiState.mode !== "loadData" && 
		...
		<Row><Col className="text-center">
			<small className="mt-4 float-right d-none d-sm-block"><a href="#" onClick={handleSwitchMode} className="text-muted">switch to full version of talkhealth</a></small>
		</Col></Row>;
	...
	return <div>
		...
		<Row><Col>
			<h2 style={{color: "#3182CE", padding: "1em 0", textAlign: "center"}}>
				<FontAwesomeIcon icon={faMedkit} alt="talkhealth logo" className="mr-2" />
				<span>{appName || "talkhealth"}</span>
			</h2>
		</Col></Row>
